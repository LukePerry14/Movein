                            ...
                            children: [
                              ...
                              if (outgoingFriendInvitesResults.isNotEmpty)
                                ListView.builder(
                                  ...
                                  itemCount:
                                      outgoingFriendInvitesResults.length,
                                  itemBuilder: (context, index) {
                                    return ClipRect(
                                      child: Slidable(
                                        endActionPane: ActionPane(
                                                    ...
                                                    showDialog<String>(
                                                        ...
                                                        builder: (BuildContext context) => CustomDialog(
                                                            id: friendSearchResults[index]
                                                                ["Id"],
                                                            foreName: friendSearchResults[index]
                                                                ["ForeName"],
                                                            age: friendSearchResults[index]
                                                                ["Age"],
                                                            uni: friendSearchResults[index]
                                                                ["Uni"],
                                                            preferences: friendSearchResults[index]
                                                                ["Preferences"],
                                                            images:
                                                                friendSearchResults[index]
                                                                    ["Images"],
                                                            bio: friendSearchResults[
                                                                index]["Bio"],
                                                            subject:
                                                                friendSearchResults[index]
                                                                    ["Subject"],
                                                            ...
                                                            builder: (BuildContext
                                                                ...
                                                                GroupExpand(
                                                                  id: blockedSearchResults[
                                                                          index]
                                                                      ["Id"],
                                                                  groupName: blockedSearchResults[
                                                                          index]
                                                                      [
                                                                      "GroupName"],
                                                                  groupPicture:
                                                                  ...
                                                                  avgNightLife:
                                                                      blockedSearchResults[
                                                                          ...
                                                                          [
                                                                          "AvgNightLife"],
                                                                  avgBedTime: blockedSearchResults[
                                                                          index]
                                                                      [
                                                                      "AvgBedTime"],
                                                                  avgYearOfStudy:
